...
# Learning Luxembourgish with Language Models
...
The dictionary even exposes an API ([https://lod.lu/api/doc](https://lod.lu/api/doc)), which made it quite effective for the model to look things up. This drastically improved the reliability of the answers.
...
The Luxembourgish version of Wikipedia contains articles about surprisingly simple words. For example, there is an article about the word *Posch* (bag):

[https://lb.wikipedia.org/wiki/Posch](https://lb.wikipedia.org/wiki/Posch)

It turned out to be quite useful. The article includes natural Luxembourgish descriptions and examples.

For instance, it explains how a bag can be carried:
...
Looking back, there is one improvement that could have made this workflow even better. After describing the image, I could have asked the model to generate an image based on my description. Comparing the generated image with the original one might have created an additional feedback loop.
...
Of course this also raises another question: what about mistakes that I simply didn’t notice?
...
* “Can you show me a source that confirms this usage?”
...
One idea I mentioned earlier was generating images from my descriptions and comparing them with the original photos. That could have created an additional feedback loop.
...
It wasn’t for lack of trying. The official Luxembourgish government body ZLS provides [https://sproochmaschinn.lu](https://sproochmaschinn.lu), which offers text-to-speech and speech-to-text models.
